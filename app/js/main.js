$(function () {
  ...
  $('.product-tabs__top-item').on('click', function (e) {
    ...
    $('.product-tabs__top-item').removeClass('product-tabs__top-item--active'); /* при клики у все будет убираться class active  */
